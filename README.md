...
- SCIEX `WIFF Reader Distributable Beta SDK` ([alpharaw/ext/sciex](alpharaw/ext/sciex)), licensed under [SCIEX_LICENSE.txt](alpharaw/ext/sciex/SCIEX_LICENSE.txt) (plain-text conversion of the original [SCIEX_LICENSE.doc](alpharaw/ext/sciex/SCIEX_LICENSE.doc)). **This SDK may be used for academic purposes only and may not be used for commercial purposes.**
