  ...
  'syms': { 'alpharaw.ext.bruker.timsdata': {},
            ...
            'alpharaw.match.psm_match': { 'alpharaw.match.psm_match.PepSpecMatch': ( 'match/psm_match.html#pepspecmatch',
                                          ...
                                          'alpharaw.match.psm_match.PepSpecMatch.__init__': ( 'match/psm_match.html#pepspecmatch.__init__',
                                                                                              'alpharaw/match/psm_match.py'),
                                          'alpharaw.match.psm_match.PepSpecMatch._add_need_columns_to_psm_df': ( 'match/psm_match.html#pepspecmatch._add_need_columns_to_psm_df',
                                                                                                                 'alpharaw/match/psm_match.py'),
                                          ...
                                          'alpharaw.match.psm_match.PepSpecMatch.get_fragment_mz_df': ( 'match/psm_match.html#pepspecmatch.get_fragment_mz_df',
                                                                                                        'alpharaw/match/psm_match.py'),
                                          'alpharaw.match.psm_match.PepSpecMatch.get_ms2_peaks': ( 'match/psm_match.html#pepspecmatch.get_ms2_peaks',
                                                                                                   'alpharaw/match/psm_match.py'),
                                          ...
                                          'alpharaw.match.psm_match.match_one_raw_with_numba': ( 'match/psm_match.html#match_one_raw_with_numba',
                                                                                                 'alpharaw/match/psm_match.py')},
            'alpharaw.match.psm_match_alphatims': { 'alpharaw.match.psm_match_alphatims.PepSpecMatchAlphaTims': ( 'match/psm_match_alphatims.html#pepspecmatchalphatims',
                                                                                                                  'alpharaw/match/psm_match_alphatims.py'),
                                                    'alpharaw.match.psm_match_alphatims.PepSpecMatchAlphaTims.get_ms2_peaks': ( 'match/psm_match_alphatims.html#pepspecmatchalphatims.get_ms2_peaks',
                                                                                                                                'alpharaw/match/psm_match_alphatims.py'),
                                                    'alpharaw.match.psm_match_alphatims.PepSpecMatchAlphaTims.match_ms2_one_raw': ( 'match/psm_match_alphatims.html#pepspecmatchalphatims.match_ms2_one_raw',
                                                                                                                                    'alpharaw/match/psm_match_alphatims.py')},
