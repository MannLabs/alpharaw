...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'alpharaw.ext.bruker.timsdata': {},
            ...
            'alpharaw.match.match_utils': { 'alpharaw.match.match_utils.match_closest_peaks': ( 'match/match_utils.html#match_closest_peaks',
                                                                                                'alpharaw/match/match_utils.py'),
                                            'alpharaw.match.match_utils.match_highest_peaks': ( 'match/match_utils.html#match_highest_peaks',
                                                                                                'alpharaw/match/match_utils.py'),
                                            'alpharaw.match.match_utils.match_profile_peaks': ( 'match/match_utils.html#match_profile_peaks',
                                                                                                'alpharaw/match/match_utils.py')},
            ...
            'alpharaw.wrappers.alphapept_wrapper': { 'alpharaw.wrappers.alphapept_wrapper.AlphaPept_HDF_MS2_Reader': ( 'wrappers/alphapept_wrapper.html#alphapept_hdf_ms2_reader',
                                                     ...
                                                     'alpharaw.wrappers.alphapept_wrapper.AlphaPept_HDF_MS2_Reader._import': ( 'wrappers/alphapept_wrapper.html#alphapept_hdf_ms2_reader._import',
                                                                                                                               'alpharaw/wrappers/alphapept_wrapper.py'),
                                                     'alpharaw.wrappers.alphapept_wrapper.AlphaPept_HDF_MS2_Reader._reset_peaks': ( 'wrappers/alphapept_wrapper.html#alphapept_hdf_ms2_reader._reset_peaks',
                                                                                                                                    'alpharaw/wrappers/alphapept_wrapper.py'),
