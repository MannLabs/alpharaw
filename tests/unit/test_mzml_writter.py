...
class TestMzMLWriter(unittest.TestCase):
    ...
    def test_basic_mzml_creation(self):
        ...
        writer = MzMLWriter(self.ms_data, output_path)
        writer.write()
    ...
    def test_binary_precision_32_bit(self):
        """Test 32-bit binary precision"""
        output_path = os.path.join(self.temp_dir.name, "test_32bit.mzML")

        # Create writer with 32-bit precision
        writer = MzMLWriter(self.ms_data, output_path, binary_precision=32)
        writer.write()
    ...
    def test_binary_precision_64_bit(self):
        """Test 64-bit binary precision (default)"""
        output_path = os.path.join(self.temp_dir.name, "test_64bit.mzML")

        # Create writer with default (64-bit) precision
        writer = MzMLWriter(self.ms_data, output_path)
        writer.write()
    ...
    def test_compression_none(self):
        ...
        output_path = os.path.join(self.temp_dir.name, "test_no_compression.mzML")

        writer = MzMLWriter(self.ms_data, output_path, compression=None)
        writer.write()
        ...
        compression_params = root.findall(
            ".//mzml:cvParam[@accession='MS:1000576']", ns
        )
    ...
    def test_compression_zlib(self):
        ...
        output_path = os.path.join(self.temp_dir.name, "test_zlib_compression.mzML")

        writer = MzMLWriter(self.ms_data, output_path, compression="zlib")
        writer.write()
        ...
        compression_params = root.findall(
            ".//mzml:cvParam[@accession='MS:1000574']", ns
        )
    ...
    def test_centroided_flag(self):
        """Test that centroided flag is properly set"""
        output_path = os.path.join(self.temp_dir.name, "test_centroided.mzML")
    ...
    def test_cv_list_structure(self):
        """Test that CV list has the correct structure"""
        output_path = os.path.join(self.temp_dir.name, "test_cv_list.mzML")
    ...
    def test_software_info(self):
        ...
        output_path = os.path.join(self.temp_dir.name, "test_software.mzML")
    ...
    def test_empty_spectrum_handling(self):
        ...
        output_path = os.path.join(self.temp_dir.name, "test_empty_spectrum.mzML")
    ...
    def test_integer_values_formatting(self):
        """Test that integer values (MS level, charge state) are properly formatted"""
        output_path = os.path.join(self.temp_dir.name, "test_integers.mzML")
        ...
        for param in ms_level_params:
            ...
            assert "." not in value, f"MS level should be integer, got {value}"
        ...
        for param in charge_params:
            value = param.get("value")
            assert "." not in value, f"Charge state should be integer, got {value}"
